...
import com.ihdyo.postit.databinding.ActivityCameraBinding
import com.ihdyo.postit.utils.ConstVal.CAMERA_X_RESULT
import com.ihdyo.postit.utils.ConstVal.KEY_IS_BACK_CAMERA
import com.ihdyo.postit.utils.ConstVal.KEY_PICTURE
import com.ihdyo.postit.utils.createFile
        ...
        imageCapture.takePicture(
            ...
            object: ImageCapture.OnImageSavedCallback {
                ...
                override fun onError(exception: ImageCaptureException) {
                    showToast(getString(string.failed_to_take_picture))
